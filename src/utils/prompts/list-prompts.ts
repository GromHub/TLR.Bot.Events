...
export default class ListPrompt {
    ...
    static async multiReactionPicker(promptInfo: PromptInfo, options: PickerOption[], amount: number): Promise<PickerOption[]> {
        ...
        const embed = new MessageEmbed()
            ...
            .setFooter('Merci à toi ! L\'équipe de la Toile Ludique Rennaise', 'https://cdn.discordapp.com/icons/1047083525414866977/633e7cd4b0952e790be0e94478474bbd.webp')
            .setDescription(createPrompt(promptInfo));

        options.forEach(option => embed.addField(`${option.emojiName}`, option.description, true));
